...
from recently_updated_yieldmosaic import colorgen, yieldmosaic_function
...
class dashclass(Tk.Frame):
        ...
        if worked:
            ...
            if sumstat == "Quantile":
                ...
                try:
                    ...
                    self.tkprint("Could not take summary,",
                                 sys.exc_info()[0], sys.exc_info()[1])
            else:
                try:
    ...
    def colloadertwo(self, colloaderwin, ylistboxprob, coltablesel):
        try:
            ...
            self.tkprint("Selecting a Data Table Containing " +
                         "a list of column names Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def plotchild(self, listboxprobwindow, xlistboxprob, ylistboxprob):
        ...
        try:
            ...
            self.tkprint("Probplot Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def mlmgo(self, mlmwin, mlmdrivercols, mlmtargetcol):
        ...
        try:
            ...
            self.tkprint("Linear Model res = ols other error",
            ...
            try:
                ...
                if worked:
                    ...
                    try:
                        ...
                        self.tkprint("Could not make a CCPR grid,",
                                     sys.exc_info()[0], sys.exc_info()[1])
            except Exception as myerr:
                self.tkprint("Fit Linear Model other error,",
                             sys.exc_info()[0], sys.exc_info()[1])
    ...
    def sortmenugo(self, sortmenuwin, sortlist):
        ...
        if len(presort) < 1:
            ...
            try:
                ...
                self.tkprint("Sort Encountered an error",
                             sys.exc_info()[0], sys.exc_info()[1])
    ...
    def arbplotgo(self, arbplotwin, arbplotcommand, arbplotfollow):
        try:
            ...
            self.tkprint("Arbitrary Plotting code Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def dropgo(self, dropwin, dropax, drophow):
        ...
        try:
            ...
            self.tkprint("Drop Missing Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def massrenamego(self, masswin, cb1, cb2, cb3, cb4,
        ...
        try:
            ...
            self.tkprint("Mass Rename Exception:",
    ...
    def uniquego(self, uniquewin, uniqcols):
        try:
            ...
            self.tkprint("Drop Duplicates Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def concatgo(self, concatwin, concattablesel):
        try:
            ...
            self.tkprint("Concatenate Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def facetcolsgo(self, facetcolswin, facetcolcol, facethuecol,
        ...
        try:
            ...
            self.tkprint("FacetGrid Plot Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def anovago(self, anovawin, anvgpcol, anvtgcols):
        try:
            ...
            self.tkprint("F-Oneway Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def lofgo(self, lofwin, labelcols, lofcols):
        try:
            ...
            self.tkprint("Outliers Finder Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def clusgo(self, cluswin, cluslabelcols, clusvalcols, numclus):
        try:
            ...
            self.tkprint("Cluster Finding Exception:",
                         sys.exc_info()[0], sys.exc_info()[1])
    ...
    def scrollvalmenutwo(self, scrollvalwin, scrollvalcol):
        ...
        try:
            ...
            self.tkprint("You did not select a column")
        if valcol is not None:
            try:
                ...
                self.tkprint("Scroll to Value Menu Exception",
                             sys.exc_info()[0], sys.exc_info()[1])
    ...
    def scrollvalgo(self, scrollvalwintwo, valcol, scrollvalval):
        ...
        try:
            ...
            self.tkprint("You did not select a value to scroll to")
